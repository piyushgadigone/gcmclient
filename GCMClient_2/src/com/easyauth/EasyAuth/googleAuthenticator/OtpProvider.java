...
package com.easyauth.EasyAuth.googleAuthenticator;

import java.io.UnsupportedEncodingException;
import java.security.GeneralSecurityException;
import java.util.Collection;

import com.easyauth.EasyAuth.googleAuthenticator.AccountDb.OtpType;
import com.easyauth.EasyAuth.googleAuthenticator.PasscodeGenerator.Signer;
...
public class OtpProvider implements OtpSource {
  ...
  public String computePin(String secret, long otp_state)
      throws OtpSourceException {
    if (secret == null || secret.length() == 0) {
      throw new OtpSourceException("Null or empty secret");
    }
